...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center lg:px-32 px-5 text-black bg-black bg-[url('assets/img/herosection.jpg')] bg-no-repeat bg-cover bg-opacity-90" >
